...
memberlimit = 2
cr = '*AMR BOT*'
vz = '*Terima Kasih Sudah Daftar Di AMR BOT*'
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:Rifky\n'
            + 'ORG:Creator AMR BOT;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6285705980176:+62 857-0598-0176\n'
            + 'END:VCARD'
/*
]=====> SETTINGS <=====[
*/
const ownerNumber = ["6285705980176@s.whatsapp.net"]
const frendsowner = ["6281260249730@s.whatsapp.net"]
const vip = ["6287722244330@s.whatsapp.net"]
const botName = 'AMR BOT'
const ownerName = 'Rifky'
const apiKey = 'Apikey'
		...
		try {
			...
			const taukah = mek.message.conversation
				...
				only: {
					...
					public: '☒ Jika Ingin Menggunakan Bot Harap Masuk Ke Dalam Grup AMR BOT, ketik .AMRGroup!\nJika Ingin Sewa Bot atau Bikin Bot Harap Ketik *.iklan*! ',
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
costum( '*AMR BOT GROUP*\n\n*BOTWA ABAD 1*\nhttps://chat.whatsapp.com/Ly5emfuY9MNG5csOTUme7Q', text, tescuk, cr)
break
case 'rules':
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
...
break
            ...
            default:
                  ...
                  if (budy == 'Cekprefix') {
                  reply(`*AMR BOT USING PREFIX [ ${prefix} ]*`)
                  }
