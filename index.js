...
*/
const ownerNumber = ["6281515474080@s.whatsapp.net"]
const frendsowner = ["6281515474080@s.whatsapp.net"]
const vip = ["6281515474080@s.whatsapp.net"]
const botName = 'Berjualaan BOT'
const ownerName = 'AhmadChenDev'
const apiKey = 'Apikey'
